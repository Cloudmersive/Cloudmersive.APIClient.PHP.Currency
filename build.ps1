...
& java -jar swagger-codegen-cli.jar generate -i https://api.cloudmersive.com/swagger/api/currency -l php -c packageconfig.json
#(Get-Content ./client/package.json).replace('v1', '1.0.1') | Set-Content ./client/package.json
Copy-Item ./cloudmersive_currency_api_client/* -Destination . -Recurse -Force
Remove-Item –path ./cloudmersive_currency_api_client –recurse
...
(Get-Content ./README.md).replace('This PHP package is automatically generated by the [Swagger Codegen](https://github.com/swagger-api/swagger-codegen) project:', '[Cloudmersive Currency API](https://www.cloudmersive.com/currency-api) help you retrieve exchange rates and convert prices between currencies easily.') | Set-Content ./README.md
